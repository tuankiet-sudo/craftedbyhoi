...
const heroBg = "/main2.png";
const contentBg = "/aboutus_background.jpg";
    ...
    <Box>
      ...
      <Box
        sx={{
          ...
          px: { xs: 1, md: 0 }, // Padding for mobile so text doesn't touch edge
          '&::before': {
            content: '""',
            position: 'absolute',
            inset: 0,
      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            inset: 0,
            zIndex: 0,
            // Optionally add a semi-transparent overlay for text contrast:
            background: { xs: "rgba(255,255,255,0.89)", md: "rgba(255,255,255,0.93)" }
          }
        }}
      >
