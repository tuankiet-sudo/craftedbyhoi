            ...
            <Grid size={{xs:12, sm:6, md:4}} key={product.id}>
              <Card
                ...
                sx={{
                  ...
                  boxShadow: hovered === product.id ? 3 : 0,
                  p: 1.5,
                  background: '#fff',
                  overflow: 'hidden',
                }}
              ...
              >
                <Box sx={{ position: 'relative', height: 320, mb: 2 }}>
                  <Fade in={hovered === product.id} timeout={400}>
                    <Box
                      sx={{
                        position: 'absolute',
                        inset: 0,
                        ...
                        display: hovered === product.id ? 'flex' : 'none',
                        alignItems: 'center',
                  ...
                  <CardMedia
                    component="img"
                    image={hovered === product.id ? product.images[1] : product.images[0]}
                    alt={product.name}
                    sx={{
                      width: '100%',
                      height: 320,
